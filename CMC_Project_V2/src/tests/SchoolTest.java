...
public class SchoolTest {
	...
	public void setUp() throws Exception {
		school1 = new School("University of Minnesota","Minnesota", "URBAN", "UNKNOWN", 500000, .45, 20,30,5000.0,.3,1000,.5,.3,4,3,5,"compsci");
	}
	//-----------------------------------------------------------Test getters-------------------------------------------------------------
	@Test
	...
	public void testGetEmphasis() {
		assertTrue("getEmphasis working", school1.getQualOfLife() == "compsci");
	}
	@Test
	public void testGetSchool() {
		assertTrue("getSchool working", school1.getQualOfLife() == "University of Minnesota");
	}
	...
	public void testSetEmphasis() {
		...
		assertTrue("setEmphasis working", school1.getQualOfLife() == "code");
	}
	@Test
	public void testSetSchool() {
		school1.setSchool("U of M");
		assertTrue("setSchool working", school1.getQualOfLife() == "U of M");
	}
	//---------------------------------------------Test Failures------------------------------------------------
